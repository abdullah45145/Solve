...
const ChartCard = () => {
  return (
    <div className="w-[430px] h-[410px] bg-[#120D2B] rounded-2xl m-30 flex items-end justify-center overflow-hidden">
      {/* Bars Container */}
      <div className="flex items-end w-full h-full">
       ...
       <div>
          ...
          <div className="w-full h-[320px] bg-[#2E264B] rounded-t-2xl flex items-end justify-center">
            {/* <div className="w-full h-full bg-[#6E34D8] rounded-t-2xl flex items-end justify-center"> */}
        ...
        <div className="flex flex-col items-center justify-end space-y-3 w-1/3 h-full">
          ...
          <div className="w-full h-[240px] bg-[#2B1B54] rounded-t-2xl flex items-end justify-center">
            {/* <div className="w-full h-full bg-[#602FCF] rounded-t-2xl flex items-end justify-center"> */}
        ...
        <div className="flex flex-col items-center space-y-4 justify-end w-1/3 h-full">
         <div>
          ...
          <div className="w-full h-[170px] bg-[#2B1B54] rounded-t-2xl flex items-end justify-center">
            {/* <div className="w-full h-2 bg-[#080709] rounded-t-2xl flex items-end justify-center"> */}
